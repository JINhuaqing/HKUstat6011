...
u1, u2 = us1000[us1000<=probs1000]*C*g(x1), us1000[us1000>probs1000]*C*g(x2)
plt.figure(figsize=(20, 10))
plt.xlim([-10, 10])
plt.plot(x1, u1, 'o', color='pink', label='accepted samples')
plt.plot(x2, u2, 'x', color='y', label='rejected samples')
plt.plot(x, laplace.pdf(x), 'r-.', label='laplace distribution')
plt.plot(x, t2.pdf(x), 'g-', label='t2 distribution')
plt.plot(x, C*t2.pdf(x), 'b--', label='t2 distribution with C')
plt.legend()
